...
class ElementResourceIT {
    ...
    private static final String DEFAULT_ELEMENT_TEXT = "AAAAAAAAAA";
    private static final String UPDATED_ELEMENT_TEXT = "BBBBBBBBBB";

    private static final String DEFAULT_ELEMENT_AUDIO_PATH = "AAAAAAAAAA";
    private static final String UPDATED_ELEMENT_AUDIO_PATH = "BBBBBBBBBB";
    ...
    public static Element createEntity(EntityManager em) {
        Element element = new Element().elementText(DEFAULT_ELEMENT_TEXT).elementAudioPath(DEFAULT_ELEMENT_AUDIO_PATH);
        return element;
    }
    ...
    public static Element createUpdatedEntity(EntityManager em) {
        Element element = new Element().elementText(UPDATED_ELEMENT_TEXT).elementAudioPath(UPDATED_ELEMENT_AUDIO_PATH);
        return element;
    }
    ...
    void createElement() throws Exception {
        ...
        assertThat(testElement.getElementText()).isEqualTo(DEFAULT_ELEMENT_TEXT);
        assertThat(testElement.getElementAudioPath()).isEqualTo(DEFAULT_ELEMENT_AUDIO_PATH);
    }
    ...
    @Test
    @Transactional
    void checkElementTextIsRequired() throws Exception {
        int databaseSizeBeforeTest = elementRepository.findAll().size();
        // set the field null
        element.setElementText(null);
    ...
    @Test
    @Transactional
    void checkElementAudioPathIsRequired() throws Exception {
        int databaseSizeBeforeTest = elementRepository.findAll().size();
        // set the field null
        element.setElementAudioPath(null);
    ...
    void getAllElements() throws Exception {
        ...
        restElementMockMvc
            ...
            .andExpect(jsonPath("$.[*].elementText").value(hasItem(DEFAULT_ELEMENT_TEXT)))
            .andExpect(jsonPath("$.[*].elementAudioPath").value(hasItem(DEFAULT_ELEMENT_AUDIO_PATH)));
    }
    ...
    void getElement() throws Exception {
        ...
        restElementMockMvc
            ...
            .andExpect(jsonPath("$.elementText").value(DEFAULT_ELEMENT_TEXT))
            .andExpect(jsonPath("$.elementAudioPath").value(DEFAULT_ELEMENT_AUDIO_PATH));
    }
    ...
    void putExistingElement() throws Exception {
        ...
        updatedElement.elementText(UPDATED_ELEMENT_TEXT).elementAudioPath(UPDATED_ELEMENT_AUDIO_PATH);
        ...
        Element testElement = elementList.get(elementList.size() - 1);
        assertThat(testElement.getElementText()).isEqualTo(UPDATED_ELEMENT_TEXT);
        assertThat(testElement.getElementAudioPath()).isEqualTo(UPDATED_ELEMENT_AUDIO_PATH);
    }
    ...
    void partialUpdateElementWithPatch() throws Exception {
        ...
        partialUpdatedElement.elementText(UPDATED_ELEMENT_TEXT).elementAudioPath(UPDATED_ELEMENT_AUDIO_PATH);
