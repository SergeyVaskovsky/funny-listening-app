            ...
            <tbody>
              {elementList.map((element, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {element.entireStoryElement ? (
                      <Link to={`/story/${element.entireStoryElement.id}`}>{element.entireStoryElement.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  <td>{element.element ? <Link to={`/story/${element.element.id}`}>{element.element.id}</Link> : ''}</td>
