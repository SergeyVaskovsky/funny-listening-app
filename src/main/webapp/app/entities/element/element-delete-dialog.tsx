...
export const ElementDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="funnyListeningApp.element.delete.question">Are you sure you want to delete Element {elementEntity.id}?</ModalBody>
      <ModalFooter>
