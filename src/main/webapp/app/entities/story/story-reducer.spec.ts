...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './story.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_STORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STORY actions', async () => {
      const expectedActions = [
        {
