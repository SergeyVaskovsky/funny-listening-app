...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REFERALLINK_LIST actions', async () => {
    ...
    it('dispatches FETCH_REFERALLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REFERALLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REFERALLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REFERALLINK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REFERALLINK actions', async () => {
      const expectedActions = [
        {
